...
In the test folder, there is a simple game engine that uses Java2D in order to show how the library works (taken from my blog - gameprogblog.com). To run the demo download jimpulse-demo.jar and run it.
